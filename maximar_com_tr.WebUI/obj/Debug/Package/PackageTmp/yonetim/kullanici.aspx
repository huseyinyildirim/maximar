<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kullanici.aspx.cs" Inherits="maximar_com_tr.WebUI.yonetim.kullanici" %>
        ...
        <asp:UpdatePanel runat="server" ID="update_tablo">
            <ContentTemplate>
                <div class="blokbaslik">
                    Ana Sayfa » Kullanıcı Yönetimi » Kullanıcılar</div>
                    ...
                    <div class="blokkomut">
                        <asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" OnClick="secilenlerisil_Click"
                            OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button
                                ID="yeniekle" runat="server" Text="Yeni Kullanıcı Ekle" OnClick="yeniekle_Click" />
                    </div>
                </div>
            </ContentTemplate>
            <Triggers>
