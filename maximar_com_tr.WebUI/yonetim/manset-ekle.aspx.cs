                ...
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    ...
                    if (SQL.Any())
                    {
                        ...
                        foreach (var i in SQL)
                        {
                            ...
                            tbl.dil_id = i.id;
                            tbl.detay = Request.Form["txt_baslik_" + i.id.ToString()].ToString().Trim();
                            ...
                            tbl.admin_id = int.Parse(HttpContext.Current.Request.Cookies[Class.Fonksiyonlar.Ayar(Class.Sabitler.Ayar.GuvenlikKodu) + "KullaniciID"].Value);
