<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ayar-dil.aspx.cs" Inherits="maximar_com_tr.WebUI.yonetim.ayar_dil" %>
        ...
        <asp:UpdatePanel runat="server" ID="update_tablo">
            <ContentTemplate>
                <div class="blokbaslik">
                    Ana Sayfa » Ayarlar » Dil Ayarları</div>
                <div class="blokicerik">
                    ...
                    <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" OnRowDataBound="kayitlar_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="dil" HeaderText="Dil" HtmlEncode="false" HeaderStyle-HorizontalAlign="Left" />
                    ...
                    <div class="blokkomut">
                        <asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" OnClick="secilenlerisil_Click"
                            OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button
                                ID="yeniekle" runat="server" Text="Yeni Domain Ekle" OnClick="yeniekle_Click" />
                    </div>
                </div>
            </ContentTemplate>
            <Triggers>
