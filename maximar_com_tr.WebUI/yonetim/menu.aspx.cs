    ...
    public partial class menu : System.Web.UI.Page
    {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL = (from a in db.tbl_menu
                           select new
                           {
                               a.id,
                               a.baslik,
                               ust_kategori = (db.tbl_menu.Where(k => k.id == a.ust_menu_id).Select(k => k.baslik).FirstOrDefault()) == null ? "Ana Kategori" : (db.tbl_menu.Where(k => k.id == a.ust_menu_id).Select(k => k.baslik).FirstOrDefault()),
                               a.onay,
                               a.tarih_ek,
                               a.tarih_gun,
        ...
        protected void kayitlar_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    case "True":
                        e.Row.Cells[5].Text = "<img src=\"img/komut-aktif.png\" />";
                        break;

                    case "False":
                        e.Row.Cells[5].Text = "<img src=\"img/komut-pasif.png\" />";
                        break;
                }

                e.Row.Cells[7].Text = "<a href=\"menu-duzenle.aspx?ID=" + e.Row.Cells[1].Text + "\"><img src=\"img/komut-duzenle.png\" /></a>";
            }
        }
