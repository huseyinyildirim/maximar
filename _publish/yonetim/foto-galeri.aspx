<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="foto-galeri.aspx.cs" Inherits="maximar_com_tr.WebUI.yonetim.foto_galeri" %>
        ...
        <asp:UpdatePanel runat="server" ID="update_tablo">
            <ContentTemplate>
                <div class="blokbaslik">
                    Ana Sayfa » Galeri Yönetimi » Foto Galeriler</div>
                    ...
                    <div class="blokkomut">
                        <asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" OnClick="secilenlerisil_Click"
                            OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button
                                ID="yeniekle" runat="server" Text="Yeni Foto Galeri Ekle" OnClick="yeniekle_Click" />
                    </div>
                </div>
            </ContentTemplate>
            <Triggers>
