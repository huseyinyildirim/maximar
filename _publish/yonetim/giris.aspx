<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giris.aspx.cs" Inherits="maximar_com_tr.WebUI.yonetim.giris" %>
        ...
        <table align="center">
            <tbody>
                ...
                <tr>
                    ...
                    <td align="left">
                        <recaptcha:RecaptchaControl ID="recaptcha" runat="server" PublicKey="6LcDV8cSAAAAALdERhuFLj4NG0s8MogWbkzUFl5O"
                            PrivateKey="6LcDV8cSAAAAACvCUmAhhW__GnERGHIsURfmkeEB" Language="tr" />
                    </td>
                </tr>
                <tr>
                    <td>
