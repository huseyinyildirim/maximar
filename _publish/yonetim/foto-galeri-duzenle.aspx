<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="foto-galeri-duzenle.aspx.cs" Inherits="maximar_com_tr.WebUI.yonetim.foto_galeri_duzenle"
                    ...
                    <asp:ListView runat="server" ID="lv_foto_veriler" GroupItemCount="5">
                        ...
                        <ItemTemplate>
                            <td valign="top" style="text-align: center;">
                                <img src="/ashx/image-view.ashx?i=upload/photo-gallery/<%#Eval("dosya_ad")%>&amp;w=150&amp;h=150&amp;k=t"
                        ...
                        <EmptyDataTemplate>
                            <p>
                                <% Response.Write(maximar_com_tr.WebUI.Class.Fonksiyonlar.Textler(181)); %></p>
                        </EmptyDataTemplate>
                    </asp:ListView>
                </div>
            </fieldset>
