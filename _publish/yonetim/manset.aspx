<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manset.aspx.cs" Inherits="maximar_com_tr.WebUI.yonetim.manset" %> 
    ...
    <asp:ScriptManager runat="server" ID="sm"></asp:ScriptManager>
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » İçerik Yönetimi » Manşetler</div>
                    <div class="blokicerik">
                        ...
                        <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" onrowdatabound="kayitlar_RowDataBound" AutoGenerateColumns="false" onrowcommand="kayitlar_RowCommand" DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="son_gosterim_tarih" HeaderText="Son Gösterim" HtmlEncode="false" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <asp:TemplateField HeaderText="Ekleyen" ItemStyle-Width="120" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container.DataItem, "ekleyen")%><br /><%# DataBinder.Eval(Container.DataItem, "tarih_ek")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Güncelleyen" ItemStyle-Width="120" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container.DataItem, "guncelleyen")%><br /><%# DataBinder.Eval(Container.DataItem, "tarih_gun")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        ...
                        <div class="blokkomut"><asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" onclick="secilenlerisil_Click" OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button 
                                ID="yeniekle" runat="server" Text="Yeni Manşet Ekle" 
