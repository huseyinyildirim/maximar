<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ayar-statik-kelime-duzenle.aspx.cs"
    Inherits="maximar_com_tr.WebUI.yonetim.statik_kelime_duzenle" ValidateRequest="false" %>
...
<body>
    ...
    <div class="icerik">
        <div class="blokbaslik">
            Ana Sayfa » Ayarlar » Statik Kelime Ayarları » Statik Kelime Düzenle</div>
